...
StoragedError
iscsi_error_to_storaged_error (const gint err)
{
  switch (err)
    {
      case ISCSI_ERR_TRANS: /* 4 */
        return STORAGED_ERROR_ISCSI_TRANSPORT_FAILED;
      case ISCSI_ERR_LOGIN: /* 5 */
        return STORAGED_ERROR_ISCSI_LOGIN_FAILED;
      case ISCSI_ERR_IDBM: /* 6 */
        return STORAGED_ERROR_ISCSI_IDMB;
      case ISCSI_ERR_LOGOUT: /* 10 */
        return STORAGED_ERROR_ISCSI_LOGOUT_FAILED;
      case ISCSI_ERR_ISCSID_COMM_ERR: /* 18 */
        return STORAGED_ERROR_ISCSI_DAEMON_TRANSPORT_FAILED;
      case ISCSI_ERR_FATAL_LOGIN: /* 19 */
        return STORAGED_ERROR_ISCSI_LOGIN_FATAL;
      case ISCSI_ERR_ISCSID_NOTCONN: /* 20 */
        return STORAGED_ERROR_ISCSI_NOT_CONNECTED;
      case ISCSI_ERR_NO_OBJS_FOUND: /* 21 */
        return STORAGED_ERROR_ISCSI_NO_OBJECTS_FOUND;
      case ISCSI_ERR_HOST_NOT_FOUND: /* 23 */
        return STORAGED_ERROR_ISCSI_HOST_NOT_FOUND;
      case ISCSI_ERR_LOGIN_AUTH_FAILED: /* 24 */
        return STORAGED_ERROR_ISCSI_LOGIN_AUTH_FAILED;
      case ISCSI_ERR_UNKNOWN_DISCOVERY_TYPE: /* 30 */
        return STORAGED_ERROR_ISCSI_UNKNOWN_DISCOVERY_TYPE;
