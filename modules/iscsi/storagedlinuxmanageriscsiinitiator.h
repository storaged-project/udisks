...
#ifndef __STORAGED_LINUX_MANAGER_ISCSI_INITIATOR_H__
#define __STORAGED_LINUX_MANAGER_ISCSI_INITIATOR_H__
...
#define STORAGED_TYPE_LINUX_MANAGER_ISCSI_INITIATOR            (storaged_linux_manager_iscsi_initiator_get_type ())
#define STORAGED_LINUX_MANAGER_ISCSI_INITIATOR(o)              (G_TYPE_CHECK_INSTANCE_CAST  ((o), STORAGED_TYPE_LINUX_MANAGER_ISCSI_INITIATOR, StoragedLinuxManagerISCSIInitiator))
#define STORAGED_IS_LINUX_MANAGER_ISCSI_INITIATOR(o)           (G_TYPE_CHECK_INSTANCE_TYPE  ((o), STORAGED_TYPE_LINUX_MANAGER_ISCSI_INITIATOR))
#define STORAGED_LINUX_MANAGER_ISCSI_INITIATOR_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), STORAGED_TYPE_LINUX_MANAGER_ISCSI_INITIATOR, StoragedLinuxManagerISCSIInitiatorClass))
#define STORAGED_IS_LINUX_MANAGER_ISCSI_INITIATOR_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), STORAGED_TYPE_LINUX_MANAGER_ISCSI_INITIATOR))
...
#endif /* __STORAGED_LINUX_MANAGER_ISCSI_INITIATOR_H__ */
