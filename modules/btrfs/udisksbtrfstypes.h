...
#ifndef __UDISKS_BTRFS_TYPES_H__
...
typedef struct _UDisksLinuxFilesystemBTRFS        UDisksLinuxFilesystemBTRFS;
typedef struct _UDisksLinuxFilesystemBTRFSClass   UDisksLinuxFilesystemBTRFSClass;

#endif /* __UDISKS_BTRFS_TYPES_H__ */
