 ...
 * @title: StoragedLinuxDriveAta
 * @short_description: Linux implementation of #StoragedDriveAta
 *
 * This type provides an implementation of the #StoragedDriveAta
 * interface on Linux.
 */

typedef struct _StoragedLinuxDriveAtaClass   StoragedLinuxDriveAtaClass;

/**
 * StoragedLinuxDriveAta:
 *
 * The #StoragedLinuxDriveAta structure contains only private data and should
 * only be accessed using the provided API.
 */
struct _StoragedLinuxDriveAta
{
  StoragedDriveAtaSkeleton parent_instance;
...
struct _StoragedLinuxDriveAtaClass
{
  StoragedDriveAtaSkeletonClass parent_class;
};

static void drive_ata_iface_init (StoragedDriveAtaIface *iface);

G_DEFINE_TYPE_WITH_CODE (StoragedLinuxDriveAta, storaged_linux_drive_ata, STORAGED_TYPE_DRIVE_ATA_SKELETON,
                         G_IMPLEMENT_INTERFACE (STORAGED_TYPE_DRIVE_ATA, drive_ata_iface_init));
...
static void
storaged_linux_drive_ata_finalize (GObject *object)
{
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (object);

  if (drive->smart_attributes != NULL)
    g_variant_unref (drive->smart_attributes);

  if (G_OBJECT_CLASS (storaged_linux_drive_ata_parent_class)->finalize != NULL)
    G_OBJECT_CLASS (storaged_linux_drive_ata_parent_class)->finalize (object);
}


static void
storaged_linux_drive_ata_init (StoragedLinuxDriveAta *drive)
{
...
static void
storaged_linux_drive_ata_class_init (StoragedLinuxDriveAtaClass *klass)
{
  GObjectClass *gobject_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = storaged_linux_drive_ata_finalize;
}
 ...
 *
 * Returns: A new #StoragedLinuxDriveAta. Free with g_object_unref().
 */
StoragedDriveAta *
storaged_linux_drive_ata_new (void)
{
  return STORAGED_DRIVE_ATA (g_object_new (STORAGED_TYPE_LINUX_DRIVE_ATA,
                                         NULL));
}
...
static void
update_smart (StoragedLinuxDriveAta *drive,
              StoragedLinuxDevice   *device)
{
  ...
  word_82 = storaged_ata_identify_get_word (device->ata_identify_device_data, 82);
  word_85 = storaged_ata_identify_get_word (device->ata_identify_device_data, 85);
  ...
  storaged_drive_ata_set_smart_supported (STORAGED_DRIVE_ATA (drive), supported);
  storaged_drive_ata_set_smart_enabled (STORAGED_DRIVE_ATA (drive), enabled);
  storaged_drive_ata_set_smart_updated (STORAGED_DRIVE_ATA (drive), updated);
  storaged_drive_ata_set_smart_failing (STORAGED_DRIVE_ATA (drive), failing);
  storaged_drive_ata_set_smart_temperature (STORAGED_DRIVE_ATA (drive), temperature);
  storaged_drive_ata_set_smart_power_on_seconds (STORAGED_DRIVE_ATA (drive), power_on_seconds);
  storaged_drive_ata_set_smart_num_attributes_failing (STORAGED_DRIVE_ATA (drive), num_attributes_failing);
  storaged_drive_ata_set_smart_num_attributes_failed_in_the_past (STORAGED_DRIVE_ATA (drive), num_attributes_failed_in_the_past);
  storaged_drive_ata_set_smart_num_bad_sectors (STORAGED_DRIVE_ATA (drive), num_bad_sectors);
  storaged_drive_ata_set_smart_selftest_status (STORAGED_DRIVE_ATA (drive), selftest_status);
  storaged_drive_ata_set_smart_selftest_percent_remaining (STORAGED_DRIVE_ATA (drive), selftest_percent_remaining);
...
static void
update_pm (StoragedLinuxDriveAta *drive,
           StoragedLinuxDevice   *device)
{
  ...
  /* ATA8: 7.16 IDENTIFY DEVICE - ECh, PIO Data-In - Table 29 IDENTIFY DEVICE data */
  word_82 = storaged_ata_identify_get_word (device->ata_identify_device_data, 82);
  word_83 = storaged_ata_identify_get_word (device->ata_identify_device_data, 83);
  word_85 = storaged_ata_identify_get_word (device->ata_identify_device_data, 85);
  word_86 = storaged_ata_identify_get_word (device->ata_identify_device_data, 86);
  word_94 = storaged_ata_identify_get_word (device->ata_identify_device_data, 94);
  ...
  g_object_freeze_notify (G_OBJECT (drive));
  storaged_drive_ata_set_pm_supported (STORAGED_DRIVE_ATA (drive), !!pm_supported);
  storaged_drive_ata_set_pm_enabled (STORAGED_DRIVE_ATA (drive), !!pm_enabled);
  storaged_drive_ata_set_apm_supported (STORAGED_DRIVE_ATA (drive), !!apm_supported);
  storaged_drive_ata_set_apm_enabled (STORAGED_DRIVE_ATA (drive), !!apm_enabled);
  storaged_drive_ata_set_aam_supported (STORAGED_DRIVE_ATA (drive), !!aam_supported);
  storaged_drive_ata_set_aam_enabled (STORAGED_DRIVE_ATA (drive), !!aam_enabled);
  storaged_drive_ata_set_aam_vendor_recommended_value (STORAGED_DRIVE_ATA (drive), aam_vendor_recommended_value);
  storaged_drive_ata_set_write_cache_supported (STORAGED_DRIVE_ATA (drive), !!write_cache_supported);
  storaged_drive_ata_set_write_cache_enabled (STORAGED_DRIVE_ATA (drive), !!write_cache_enabled);
  storaged_drive_ata_set_read_lookahead_supported (STORAGED_DRIVE_ATA (drive), !!read_lookahead_supported);
  storaged_drive_ata_set_read_lookahead_enabled (STORAGED_DRIVE_ATA (drive), !!read_lookahead_enabled);
  g_object_thaw_notify (G_OBJECT (drive));
}
...
static void
update_security (StoragedLinuxDriveAta *drive,
                 StoragedLinuxDevice   *device)
{
  gint erase_unit = 0;
  ...
  word_82  = storaged_ata_identify_get_word (device->ata_identify_device_data, 82);
  word_85  = storaged_ata_identify_get_word (device->ata_identify_device_data, 85);
  word_89  = storaged_ata_identify_get_word (device->ata_identify_device_data, 89);
  word_90  = storaged_ata_identify_get_word (device->ata_identify_device_data, 90);
  word_128 = storaged_ata_identify_get_word (device->ata_identify_device_data, 128);
  ...
  storaged_drive_ata_set_security_supported (STORAGED_DRIVE_ATA (drive), !!security_supported);
  storaged_drive_ata_set_security_enabled (STORAGED_DRIVE_ATA (drive), !!security_enabled);
  */
  storaged_drive_ata_set_security_erase_unit_minutes (STORAGED_DRIVE_ATA (drive), erase_unit);
  storaged_drive_ata_set_security_enhanced_erase_unit_minutes (STORAGED_DRIVE_ATA (drive), enhanced_erase_unit);
  storaged_drive_ata_set_security_frozen (STORAGED_DRIVE_ATA (drive), !!frozen);
  g_object_thaw_notify (G_OBJECT (drive));
}
 ...
 */
gboolean
storaged_linux_drive_ata_update (StoragedLinuxDriveAta    *drive,
...
static gboolean get_pm_state (StoragedLinuxDevice *device, GError **error, guchar *count)
{
  int fd;
  gboolean rc = FALSE;
  /* ATA8: 7.8 CHECK POWER MODE - E5h, Non-Data */
  StoragedAtaCommandInput input = {.command = 0xe5};
...
static gboolean update_io_stats (StoragedLinuxDriveAta *drive, StoragedLinuxDevice *device)
{
  ...
  if (statf == NULL)
    {
      storaged_warning ("Failed to open %s\n", statpath);
    }
  else
    {
      ...
      storaged_debug ("drive_read=%lu, drive_write=%lu, old_drive_read=%lu, old_drive_write=%lu\n",
 ...
 * @drive: The #StoragedLinuxDriveAta to refresh.
 ...
 */
gboolean
storaged_linux_drive_ata_refresh_smart_sync (StoragedLinuxDriveAta  *drive,
                                             gboolean                nowakeup,
                                             ...
                                             GError                **error)
{
  ...
  if (drive->secure_erase_in_progress)
    {
      g_set_error (error, STORAGED_ERROR, STORAGED_ERROR_DEVICE_BUSY,
 ...
 */
gboolean
storaged_linux_drive_ata_smart_selftest_sync (StoragedLinuxDriveAta     *drive,
                                              const gchar               *type,
                                              GCancellable              *cancellable,
                                              GError                   **error)
{
...
static gboolean
handle_smart_update (StoragedDriveAta        *_drive,
                     GDBusMethodInvocation   *invocation,
                     GVariant                *options)
{
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (_drive);
  StoragedLinuxDriveObject *object;
  ...
  block_object = storaged_linux_drive_object_get_block (object, TRUE);
  ...
  action_id = "org.storaged.Storaged.ata-smart-update";
  ...
  if (atasmart_blob != NULL)
    {
      ...
      action_id = "org.storaged.Storaged.ata-smart-simulate";
    }
  else
    {
      if (!storaged_drive_ata_get_smart_supported (STORAGED_DRIVE_ATA (drive)))
        {
          g_dbus_method_invocation_return_error (invocation,
                                                 STORAGED_ERROR,
                                                 STORAGED_ERROR_FAILED,
      ...
      if (!storaged_drive_ata_get_smart_enabled (STORAGED_DRIVE_ATA (drive)))
        {
          g_dbus_method_invocation_return_error (invocation,
                                                 STORAGED_ERROR,
                                                 STORAGED_ERROR_FAILED,
  ...
  error = NULL;
  if (!storaged_linux_drive_ata_refresh_smart_sync (drive,
                                                    nowakeup,
                                                    atasmart_blob,
                                                    NULL, /* cancellable */
                                                    &error))
    {
      storaged_warning ("Error updating ATA smart for %s: %s (%s, %d)",
  ...
  storaged_drive_ata_complete_smart_update (STORAGED_DRIVE_ATA (drive), invocation);
...
static gboolean
handle_smart_get_attributes (StoragedDriveAta        *_drive,
                             GDBusMethodInvocation   *invocation,
                             GVariant                *options)
{
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (_drive);
  ...
  if (drive->smart_attributes == NULL)
    ...
    {
      storaged_drive_ata_complete_smart_get_attributes (STORAGED_DRIVE_ATA (drive), invocation,
...
static gboolean
handle_smart_selftest_abort (StoragedDriveAta        *_drive,
                             GDBusMethodInvocation   *invocation,
                             GVariant                *options)
{
  StoragedLinuxDriveObject  *object;
  StoragedLinuxBlockObject *block_object;
  StoragedDaemon *daemon;
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (_drive);
  GError *error;
  ...
  if (!storaged_drive_ata_get_smart_supported (STORAGED_DRIVE_ATA (drive)) ||
      !storaged_drive_ata_get_smart_enabled (STORAGED_DRIVE_ATA (drive)))
    {
      g_dbus_method_invocation_return_error (invocation,
                                             STORAGED_ERROR,
                                             STORAGED_ERROR_FAILED,
  ...
  if (!storaged_daemon_util_check_authorization_sync (daemon,
                                                      STORAGED_OBJECT (block_object),
                                                      "org.storaged.Storaged.ata-smart-selftest",
                                                      options,
                                                      /* Translators: Shown in authentication dialog when the user
  ...
  error = NULL;
  if (!storaged_linux_drive_ata_smart_selftest_sync (drive,
                                                     "abort",
                                                     NULL, /* cancellable */
                                                     &error))
    {
      storaged_warning ("Error aborting SMART selftest for %s: %s (%s, %d)",
                      g_dbus_object_get_object_path (G_DBUS_OBJECT (object)),
                      error->message, g_quark_to_string (error->domain), error->code);
      g_dbus_method_invocation_take_error (invocation, error);
      goto out;
  ...
  if (drive->selftest_job != NULL)
    {
      g_cancellable_cancel (storaged_base_job_get_cancellable (STORAGED_BASE_JOB (drive->selftest_job)));
    }
  G_UNLOCK (object_lock);
  ...
  storaged_drive_ata_complete_smart_selftest_abort (STORAGED_DRIVE_ATA (drive), invocation);
...
static gboolean
selftest_job_func (StoragedThreadedJob  *job,
                   GCancellable         *cancellable,
                   gpointer              user_data,
                   GError              **error)
{
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (user_data);
  StoragedLinuxDriveObject  *object;
  gboolean ret = FALSE;
  ...
  storaged_job_set_progress (STORAGED_JOB (job), 0.0);
  ...
  while (TRUE)
    {
      ...
      if (!storaged_linux_drive_ata_refresh_smart_sync (drive,
                                                        ...
                                                        error))
        {
          storaged_warning ("Error updating ATA smart for %s while polling during self-test: %s (%s, %d)",
                          g_dbus_object_get_object_path (G_DBUS_OBJECT (object)),
                          (*error)->message, g_quark_to_string ((*error)->domain), (*error)->code);
          goto out;
        }
      ...
      if (progress > 1.0)
        progress = 1.0;
      storaged_job_set_progress (STORAGED_JOB (job), progress);
      ...
      if (g_cancellable_is_cancelled (cancellable))
        {
          ...
          if (!storaged_linux_drive_ata_smart_selftest_sync (drive,
                                                             ...
                                                             &c_error))
            {
              storaged_warning ("Error aborting SMART selftest for %s on cancel path: %s (%s, %d)",
                                g_dbus_object_get_object_path (G_DBUS_OBJECT (object)),
          ...
          if (!storaged_linux_drive_ata_refresh_smart_sync (drive,
                                                            ...
                                                            &c_error))
            {
              storaged_warning ("Error updating ATA smart for %s on cancel path: %s (%s, %d)",
                                g_dbus_object_get_object_path (G_DBUS_OBJECT (object)),
                                c_error->message, g_quark_to_string (c_error->domain), c_error->code);
              g_clear_error (&c_error);
            }
...
static gboolean
handle_smart_selftest_start (StoragedDriveAta        *_drive,
                             GDBusMethodInvocation   *invocation,
                             const gchar             *type,
                             GVariant                *options)
{
  ...
  if (!storaged_linux_drive_ata_smart_selftest_sync (drive,
                                                     ...
                                                     &error))
    {
      storaged_warning ("Error starting SMART selftest for %s: %s (%s, %d)",
                      g_dbus_object_get_object_path (G_DBUS_OBJECT (object)),
                      error->message, g_quark_to_string (error->domain), error->code);
      g_dbus_method_invocation_take_error (invocation, error);
      goto out;
  ...
  if (drive->selftest_job == NULL)
    {
      drive->selftest_job = STORAGED_THREADED_JOB (storaged_daemon_launch_threaded_job (daemon,
  ...
  storaged_drive_ata_complete_smart_selftest_start (STORAGED_DRIVE_ATA (drive), invocation);
...
static gboolean
handle_pm_get_state (StoragedDriveAta        *_drive,
                     GDBusMethodInvocation   *invocation,
                     GVariant                *options)
{
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (_drive);
  ...
  if (!storaged_drive_ata_get_pm_supported (STORAGED_DRIVE_ATA (drive)) ||
      !storaged_drive_ata_get_pm_enabled (STORAGED_DRIVE_ATA (drive)))
    {
  ...
  if (drive->secure_erase_in_progress)
    {
      g_dbus_method_invocation_return_error (invocation, STORAGED_ERROR, STORAGED_ERROR_DEVICE_BUSY,
  ...
  action_id = "org.storaged.Storaged.ata-check-power";
  ...
  if (get_pm_state (device, &error, &count))
    storaged_drive_ata_complete_pm_get_state (_drive, invocation, count);
  else
    g_dbus_method_invocation_take_error (invocation, error);
...
static gboolean
handle_pm_standby (StoragedDriveAta        *_drive,
                   GDBusMethodInvocation   *invocation,
                   GVariant                *options)
{
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (_drive);
  ...
  action_id = "org.storaged.Storaged.ata-standby";
...

  {
    ...
    StoragedAtaCommandInput input = {.command = 0xe0};
    StoragedAtaCommandOutput output = {0};
    if (!storaged_ata_send_command_sync (fd,
                                         -1,
                                         STORAGED_ATA_COMMAND_PROTOCOL_NONE,
    ...
    storaged_drive_ata_complete_pm_standby (_drive, invocation);
  }
...
static gboolean
handle_pm_wakeup (StoragedDriveAta        *_drive,
                  GDBusMethodInvocation   *invocation,
                  GVariant                *options)
{
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (_drive);
  ...
  storaged_drive_ata_complete_pm_wakeup (_drive, invocation);
...
apply_configuration_thread_func (gpointer user_data)
{
  ...
  storaged_notice ("Applying configuration from %s/storaged/%s.conf to %s",
                   PACKAGE_SYSCONF_DIR, storaged_drive_get_id (data->drive), device_file);
  ...
  if (fd == -1)
    {
      storaged_error ("Error opening device file %s: %m", device_file);
      goto out;
    }
  ...
  if (data->ata_pm_standby != -1)
    {
      ...
      StoragedAtaCommandInput input = {.command = 0xe3, .count = data->ata_pm_standby};
      StoragedAtaCommandOutput output = {0};
      if (!storaged_ata_send_command_sync (fd,
                                           -1,
                                           STORAGED_ATA_COMMAND_PROTOCOL_NONE,
                                           ...
                                           &error))
        {
          storaged_error ("Error sending ATA command IDLE (timeout=%d) to %s: %s (%s, %d)",
      ...
      else
        {
          ...
          storaged_notice ("Set standby timer to %s (value %d) on %s [%s]",
                           pretty, data->ata_pm_standby, device_file, storaged_drive_get_id (data->drive));
          g_free (pretty);
  ...
  if (data->ata_apm_level != -1)
    {
       ...
       */
      StoragedAtaCommandInput input = {.command = 0xef, .feature = 0x05, .count = data->ata_apm_level};
      StoragedAtaCommandOutput output = {0};
      ...
      if (!storaged_ata_send_command_sync (fd,
        ...
        {
          storaged_notice ("Set APM level to %d on %s [%s]",
                           data->ata_apm_level, device_file, storaged_drive_get_id (data->drive));
        }
    }
  ...
  if (data->ata_aam_level != -1)
    {
       ...
       */
      StoragedAtaCommandInput input = {.command = 0xef, .feature = 0x42, .count = data->ata_aam_level};
      StoragedAtaCommandOutput output = {0};
      if (data->ata_apm_level == 0xff)
        {
          input.feature = 0xc2;
      ...
      if (!storaged_ata_send_command_sync (fd,
        ...
        {
          storaged_notice ("Set AAM value to %d on %s [%s]",
                           data->ata_aam_level, device_file, storaged_drive_get_id (data->drive));
        }
    }
  ...
  if (data->ata_write_cache_enabled_set)
    {
       ...
       */
      StoragedAtaCommandInput input = {.command = 0xef, .feature = 0x82};
      StoragedAtaCommandOutput output = {0};
      ...
      if (!storaged_ata_send_command_sync (fd,
        ...
        {
          storaged_notice ("%s Write-Cache on %s [%s]",
                           data->ata_write_cache_enabled ? "Enabled" : "Disabled",
                           device_file, storaged_drive_get_id (data->drive));
        }
    }
  ...
  if (data->ata_read_lookahead_enabled_set)
    {
       ...
       */
      StoragedAtaCommandInput input = {.command = 0xef, .feature = 0x55};
      StoragedAtaCommandOutput output = {0};
      ...
      if (!storaged_ata_send_command_sync (fd,
        ...
        {
          storaged_notice ("%s Read Look-ahead on %s [%s]",
 ...
 */
void
storaged_linux_drive_ata_apply_configuration (StoragedLinuxDriveAta     *drive,
                                              StoragedLinuxDevice       *device,
                                              GVariant                  *configuration)
{
  ...
  data->object = storaged_daemon_util_dup_object (drive, NULL);
  if (data->object == NULL)
    goto out;

  data->drive = storaged_object_get_drive (STORAGED_OBJECT (data->object));
  if (data->drive == NULL)
    goto out;
...
on_secure_erase_update_progress_timeout (gpointer user_data)
{
  ...
  now = g_get_real_time ();
  start = storaged_job_get_start_time (job);
  end = storaged_job_get_expected_end_time (job);
 ...
 */
gboolean
storaged_linux_drive_ata_secure_erase_sync (StoragedLinuxDriveAta     *drive,
                                            uid_t                      caller_uid,
                                            gboolean                   enhanced,
                                            GError                   **error)
{
  gboolean ret = FALSE;
  StoragedDrive *_drive = NULL;
  StoragedLinuxDriveObject *object = NULL;
  StoragedLinuxBlockObject *block_object = NULL;
  StoragedDaemon *daemon;
  StoragedLinuxDevice *device = NULL;
  ...
  g_return_val_if_fail (STORAGED_IS_LINUX_DRIVE_ATA (drive), FALSE);
  g_return_val_if_fail (error == NULL || *error == NULL, FALSE);

  object = storaged_daemon_util_dup_object (drive, &local_error);
  if (object == NULL)
    goto out;
  _drive = storaged_object_peek_drive (STORAGED_OBJECT (object));
  ...
  if (drive->secure_erase_in_progress)
    {
      g_set_error (&local_error, STORAGED_ERROR, STORAGED_ERROR_DEVICE_BUSY,
                   "Secure erase in progress");
      goto out;
    }
  ...
  /* First get the IDENTIFY data directly from the drive, for sanity checks */
  {
    ...
    StoragedAtaCommandInput input = {.command = 0xec, .count = 1};
    StoragedAtaCommandOutput output = {.buffer = identify.buf, .buffer_size = sizeof (identify.buf)};
    if (!storaged_ata_send_command_sync (fd,
                                         -1,
  ...
  /* Second, set the user password to 'xxxx' */
  {
    ...
    guchar buf[512];
    StoragedAtaCommandInput input = {.command = 0xf1, .buffer = buf, .buffer_size = sizeof (buf)};
    StoragedAtaCommandOutput output = {0};
  ...
  storaged_notice ("Commencing ATA%s secure erase of %s (%s). This operation is expected to take at least %d minutes to complete",
                   enhanced ? " enhanced" : "",
                   device_file,
                   storaged_drive_get_id (_drive),
                   num_minutes);

  /* Third... do SECURITY ERASE PREPARE */
  {
    /* ATA8: 7.42 SECURITY ERASE PREPARE - F3h, Non-Data */
    StoragedAtaCommandInput input = {.command = 0xf3};
    StoragedAtaCommandOutput output = {0};
    if (!storaged_ata_send_command_sync (fd,
                                         -1,
                                         STORAGED_ATA_COMMAND_PROTOCOL_NONE,
  ...
  /* Fourth... do SECURITY ERASE UNIT */
  {
    ...
    guchar buf[512];
    StoragedAtaCommandInput input = {.command = 0xf4, .buffer = buf, .buffer_size = sizeof (buf)};
    StoragedAtaCommandOutput output = {0};
    memset (buf, 0, sizeof (buf));
    if (enhanced)
      buf[0] |= 0x02;
  ...
  storaged_linux_block_object_reread_partition_table (STORAGED_LINUX_BLOCK_OBJECT (block_object));
 ...
 out:
  ...
  if (clear_passwd_on_failure)
    {
      ...
      guchar buf[512];
      StoragedAtaCommandInput input = {.command = 0xf6, .buffer = buf, .buffer_size = sizeof (buf)};
      StoragedAtaCommandOutput output = {0};
      ...
      if (!storaged_ata_send_command_sync (fd,
                                           ...
                                           &cleanup_error))
        {
          storaged_error ("Failed to clear user password '%s' on %s (%s) while attemping clean-up after a failed secure erase operation. You may need to manually unlock the drive. The error was: %s (%s, %d)",
                          pass,
                          device_file,
                          storaged_drive_get_id (_drive),
        ...
        {
          storaged_info ("Successfully removed user password '%s' from %s (%s) during clean-up after a failed secure erase operation",
                         pass,
                         device_file,
                         storaged_drive_get_id (_drive));
        }
  ...
  if (ret)
    {
      storaged_notice ("Finished securely erasing %s (%s)",
                       device_file,
                       storaged_drive_get_id (_drive));
    }
  else
    {
      storaged_notice ("Error securely erasing %s (%s): %s (%s, %d)",
                       device_file,
                       storaged_drive_get_id (_drive),
      ...
      if (local_error == NULL)
      ...
      else
        {
          gchar *s = g_strdup_printf ("Secure Erase failed: %s (%s, %d)",
                                      local_error->message, g_quark_to_string (local_error->domain), local_error->code);
          storaged_simple_job_complete (STORAGED_SIMPLE_JOB (job), FALSE, s);
          g_free (s);
        }
    }
  if (local_error != NULL)
...
static gboolean
handle_security_erase_unit (StoragedDriveAta        *_drive,
                            GDBusMethodInvocation   *invocation,
                            GVariant                *options)
{
  StoragedLinuxDriveAta *drive = STORAGED_LINUX_DRIVE_ATA (_drive);
  ...
  if (!storaged_linux_drive_ata_secure_erase_sync (drive, caller_uid, enhanced, &error))
    {
      g_dbus_method_invocation_return_gerror (invocation, error);
      g_error_free (error);
      goto out;
  ...
  storaged_drive_ata_complete_security_erase_unit (_drive, invocation);
...
static gboolean
handle_smart_set_enabled (StoragedDriveAta        *_drive,
                          GDBusMethodInvocation   *invocation,
                          gboolean                 value,
                          GVariant                *options)
{
  ...
  action_id = "org.storaged.Storaged.ata-smart-enable-disable";
...

  {
     ...
     */
    StoragedAtaCommandInput input = {.command = 0xb0};
    StoragedAtaCommandOutput output = {0};
    if (value)
      input.feature = 0xd8;
    else
  ...
  storaged_drive_ata_complete_smart_set_enabled (_drive, invocation);
...
static void
drive_ata_iface_init (StoragedDriveAtaIface *iface)
{
