...
#define UDISKS_LINUX_LOOP(o)           (G_TYPE_CHECK_INSTANCE_CAST ((o), UDISKS_TYPE_LINUX_LOOP, UDisksLinuxLoop))
#define UDISKS_IS_LINUX_LOOP(o)        (G_TYPE_CHECK_INSTANCE_TYPE ((o), UDISKS_TYPE_LINUX_LOOP))
