...
#ifndef __STORAGED_FSTAB_ENTRY_H__
#define __STORAGED_FSTAB_ENTRY_H__

#include "storageddaemontypes.h"

G_BEGIN_DECLS

#define STORAGED_TYPE_FSTAB_ENTRY         (storaged_fstab_entry_get_type ())
#define STORAGED_FSTAB_ENTRY(o)           (G_TYPE_CHECK_INSTANCE_CAST ((o), STORAGED_TYPE_FSTAB_ENTRY, StoragedFstabEntry))
#define STORAGED_IS_FSTAB_ENTRY(o)        (G_TYPE_CHECK_INSTANCE_TYPE ((o), STORAGED_TYPE_FSTAB_ENTRY))

GType            storaged_fstab_entry_get_type     (void) G_GNUC_CONST;
...
#endif /* __STORAGED_FSTAB_ENTRY_H__ */
